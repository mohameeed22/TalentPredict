package com.talentpredict.modules.jira.service;
...
import com.talentpredict.modules.jira.repository.TicketRepository;
...
public class JiraService {
    ...
    public TicketResponse creerTicketFormation(Long formationId) {
        ...
        description.append("Demande de formation pour: ")
            .append(formation.getUser().getPrenom()).append(" ")
            .append(formation.getUser().getNom()).append("\n\n");
