...
import com.talentpredict.core.dto.TicketResponse;
...
import com.talentpredict.core.repository.TicketRepository;
...
public class JiraService {
     ...
     */
    @Transactional
    public TicketResponse creerTicketFormation(Long formationId) {
        ...
        description.append("Demande de formation pour: ")
            .append(formation.getUtilisateur().getPrenom()).append(" ")
            .append(formation.getUtilisateur().getNom()).append("\n\n");
    ...
    public List<TicketResponse> getTicketsByFormation(Long formationId) {
    ...
    @Transactional
    public TicketResponse updateStatutTicket(Long ticketId, Ticket.StatutTicket statut) {
        Ticket ticket = ticketRepository.findById(ticketId)
            .orElseThrow(() -> new ResourceNotFoundException("Ticket non trouvé avec l'ID: " + ticketId));
        ticket.setStatut(statut);
        ticket.setDateMiseAJour(java.time.LocalDateTime.now());
    ...
    private TicketResponse convertToResponse(Ticket ticket) {
        ...
        response.setDateMiseAJour(ticket.getDateMiseAJour());
